...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
        ...
        if ($productLabelConfig['new_label']) {
            ...
            if ($newsTo != '' || $newsFrom != '') {
                if (($newsTo != '' && $newsFrom != '' && $now >= $newsFrom && $now <= $newsTo)
                    ...
                    $html .= '<div class="product-label new-label"><span>' . $productLabelConfig['new_label_text'] . '</span></div>';
                }
            }
        }
        return $html;
     ...
     * @return string
     */
    public function getFooterType2()
    {
        $enable = $this->scopeConfig->getValue('vicomage_color_config/config_color_footer/enable_footer_color',\Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        $enableColor = $this->scopeConfig->getValue('vicomage_color_config/config_color_footer/enable_footer2_color',\Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        if($enable && $enableColor) {
            return $this->scopeConfig->getValue('vicomage_color_config/config_color_footer/footer_type2',
                \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        }
        return false;
    }
     ...
     * @return string
     */
    public function getFooterType3()
    {
        $enable = $this->scopeConfig->getValue('vicomage_color_config/config_color_footer/enable_footer_color',\Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        $enableColor = $this->scopeConfig->getValue('vicomage_color_config/config_color_footer/enable_footer3_color',\Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        if($enable && $enableColor) {
            return $this->scopeConfig->getValue('vicomage_color_config/config_color_footer/footer_type3',
                \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        }
        return false;
    }
     ...
     * @return string
     */
    public function getFooterType4()
    {
        $enable = $this->scopeConfig->getValue('vicomage_color_config/config_color_footer/enable_footer_color',\Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        $enableColor = $this->scopeConfig->getValue('vicomage_color_config/config_color_footer/enable_footer4_color',\Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        if($enable && $enableColor) {
            return $this->scopeConfig->getValue('vicomage_color_config/config_color_footer/footer_type4',
                \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        }
        return false;
    }
