...
class Color extends \Magento\Config\Block\System\Config\Form\Field\FieldArray\AbstractFieldArray
{
    ...
    public function configDevelop(){
        return ($this->_scopeConfig->getValue('vicomage_color_config/general_config/config_as_developer', \Magento\Store\Model\ScopeInterface::SCOPE_STORE)) ? 'enable' : 'disable';
    }
    ...
    public function configBoolDevelop(){
        return $this->_scopeConfig->getValue('vicomage_color_config/general_config/config_as_developer', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    }
